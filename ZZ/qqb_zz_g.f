...
c     -- channel qbq         
         call zzsingres(1,2,3,4,5,6,7,za,zb,qbq1)
         call zzsingres(1,2,6,5,4,3,7,za,zb,qbq2)
c     -- channel qqb
         call zzsingres(2,1,3,4,5,6,7,za,zb,qqb1)
         call zzsingres(2,1,6,5,4,3,7,za,zb,qqb2)
c     -- channel qbg
         call zzsingres(1,7,3,4,5,6,2,za,zb,qbg1)
         call zzsingres(1,7,6,5,4,3,2,za,zb,qbg2)
c     -- channel qg
         call zzsingres(7,1,3,4,5,6,2,za,zb,qg1)
         call zzsingres(7,1,6,5,4,3,2,za,zb,qg2)
c     -- channel gq
         call zzsingres(7,2,3,4,5,6,1,za,zb,gq1)
         call zzsingres(7,2,6,5,4,3,1,za,zb,gq2)
c     -- channel gqb
         call zzsingres(2,7,3,4,5,6,1,za,zb,gqb1)
         call zzsingres(2,7,6,5,4,3,1,za,zb,gqb2)
      endif
